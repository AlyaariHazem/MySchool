...
namespace Backend.Migrations
{
    ...
    [Migration("20260414194026_AddPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmailConfirmed = true,
                            Gender = "",
                            HireDate = new DateTime(2026, 4, 14, 19, 40, 25, 768, DateTimeKind.Utc).AddTicks(3693),
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEIJGrFAsUPRGaakH74RZFi6IBUAWEccV1l+0ekpGkzVhRB1D5BL5FNd1ToSn5R1s1Q==",
            ...
            modelBuilder.Entity("Backend.Models.Master.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Models.Master.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Models.Master.RolePermission", b =>
                {
                    b.HasOne("Backend.Models.Master.Permission", "Permission")
                        .WithMany()
