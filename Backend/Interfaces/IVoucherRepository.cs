...
public interface IVoucherRepository
{
    ...
    Task<List<VouchersGuardianDTO>> GetVouchersGuardianPaginatedAsync(int? guardianID, int pageNumber, int pageSize);
    Task<int> GetVouchersGuardianTotalCountAsync(int? guardianID);
